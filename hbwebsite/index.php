 ...
 <!-- Our Facilities -->
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      <div class="col-lg-2 col-md-2 text-center bg-white rounder shadow py-4 my-3">
    ...
    <div class="swiper swiper-testimonials">
      <div class="swiper-wrapper mb-5">
        <div class="swiper-slide bg-white p-4">
          <div class="profile d-flex align-items-center mb-3s">
             <img src="images/features/star.svg" width="30px">
             <h6 class="m-0 ms-2">Random User1</h6>
          </div>
          <p>
            Lorem ípun dolor sit amet consectetur adipisicing elit.
            Id nemo excepturi, incidunt qui libero at omns iure
            magni tempora ea.
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded ">
      <iframe class="w-100 rounded" height="320px" src="https://www.google.com/maps/d/embed?mid=1IPp8JEozOseXcZ42sTJnOFhuxhs&hl=en_US&ehbc=2E312F" width="640" ></iframe>
    </div>
    <div class="col-lg-4 col-md-4">
      ...
      <div class="bg-white p-4 rounded mb-4">
        <h5>Follow us</h5>
        <a helf="#" class="d-inline-block mb-3">
